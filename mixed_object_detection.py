...
class MixedObjectDetection: 
    ...
    def __init__(self, input_aruco_positions: list | None): 
        # Initialize the webcam
        self.cap = cv2.VideoCapture(4)  # Replace 4 with the correct index if needed
        ...
        if input_aruco_positions is None: 
            ...
            self.aruco_positions = input_aruco_positions
